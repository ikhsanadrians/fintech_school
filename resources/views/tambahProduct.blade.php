            ...
            <form action="{{ route('storeProduct') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="flex flex-col w-full">
                    <div class="flex w-full gap-3">
                        <div class="flex flex-col w-full">
                            <span>price</span>
                            <input type="number" name="price" class="border p-2">
                        </div>
                        <div class="flex flex-col w-full">
                            <span>Stand</span>
                            <input type="number" name="stand" class="border p-2">
                        </div>
                    </div>
                    <div class="flex w-full gap-3">
                        <div class="flex flex-col w-full">
                            <span>stock</span>
                            <input type="number" name="stock" class="border p-2">
                        </div>
                        <div class="flex flex-col w-full">
                            <span>Category</span>
                ...
                <textarea type="text" name="desc" class="border p-2"></textarea>
                <button type="submit" class="bg-green-400 p-3 rounded-lg">Create</button>
            </form>
        </div>
